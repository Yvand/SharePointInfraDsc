configuration ConfigSpFrontend
{
    param
    (
            ...
            SetScript =
            {
                ...
                do {
                    try
                    {
                        ...
                        $Response = Invoke-WebRequest -UseBasicParsing -Uri $uri -UseDefaultCredentials -TimeoutSec 10 -ErrorAction Stop -UseBasicParsing
            ...
            SetScript =
            {
                $jobBlock = {
                    ...
                    try {
                        ...
                        Invoke-WebRequest -UseBasicParsing -Uri $uri -UseDefaultCredentials -TimeoutSec 40 -UseBasicParsing -ErrorAction SilentlyContinue
...
$outputPath = "C:\Packages\Plugins\Microsoft.Powershell.DSC\2.83.5\DSCWork\ConfigureFELegacy.0\ConfigSpFrontend"
